...
export default class App {
  ...
  addBackgroundShape() {
    ...
    window.addEventListener('resize', () => this.docheight = Math.max( this.tiltFx.body.scrollHeight, this.tiltFx.body.offsetHeight, this.tiltFx.docEl.clientHeight, this.tiltFx.docEl.scrollHeight, this.tiltFx.docEl.offsetHeight ));
